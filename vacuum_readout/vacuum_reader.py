...
def formatData(pressure_data):
    ...
    data = {
            ...
            "P1" : {
                "value" : pressure_data[0],
                "unit" : "Pa"
                },
            "P2" : {
                "value" : pressure_data[1],
                "unit" : "Pa"
                }
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename='vacuum_readout.log',level=logging.DEBUG,
    ...
    while should_continue:
        ...
        for fileno, event in events:
            if fileno == sock.fileno():
                ...
                logging.info("Presure data: " + str(pressure_data[0]) + ", " + str(pressure_data[1])) 
